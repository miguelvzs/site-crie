...
import { BarraCores, HeroEntrada, HeroItem } from "@/components/ui/motion";
  ...
  return (
    <section className="overflow-hidden bg-ink-900 text-warm-100">
      <Container className="grid items-center gap-16 py-[104px] pb-28 lg:grid-cols-[1.1fr_.9fr]">
        <HeroEntrada className="flex flex-col items-start">
          <BarraCores cores={BARRAS} className="mb-8 flex gap-[5px]" />
          <HeroItem>
          ...
          <HeroItem className="mt-10 flex flex-wrap gap-[14px]">
            <a
              href="#ajudar"
